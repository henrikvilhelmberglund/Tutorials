import{S as F,i as O,s as M,k,q as v,a as B,e as P,l as w,m as j,h as p,r as E,c as A,n as $,ad as J,b as d,ae as R,T as K,u as N,H as y,J as W,D as I,af as X,X as T,ag as Q,ah as ce,K as Z,y as H,z as C,A as L,L as fe,M as U,g as G,d as q,B as z,N as V}from"./index.0b5cc0d7.js";import{M as ue,P as Y}from"./mdsvex-layout-notes.c527e9b3.js";import"./index.8a23e261.js";/* empty css                                               */import{S as pe}from"./ShowMany.5b53376e.js";function x(s,e,n){const t=s.slice();return t[6]=e[n],t}function ee(s){let e,n=s[6]+"",t;return{c(){e=k("option"),t=v(n),this.h()},l(l){e=w(l,"OPTION",{});var o=j(e);t=E(o,n),o.forEach(p),this.h()},h(){e.__value=s[6],e.value=e.__value},m(l,o){d(l,e,o),I(e,t)},p:y,d(l){l&&p(e)}}}function he(s){let e,n;return{c(){e=k("img"),this.h()},l(t){e=w(t,"IMG",{src:!0,alt:!0}),this.h()},h(){T(e.src,n=s[1])||$(e,"src",n),$(e,"alt","dog")},m(t,l){d(t,e,l)},p(t,l){l&2&&!T(e.src,n=t[1])&&$(e,"src",n)},d(t){t&&p(e)}}}function de(s){let e,n;return{c(){e=k("p"),n=v("oops! error!")},l(t){e=w(t,"P",{});var l=j(e);n=E(l,"oops! error!"),l.forEach(p)},m(t,l){d(t,e,l),I(e,n)},p:y,d(t){t&&p(e)}}}function me(s){let e,n,t,l,o,h,c,_,S,m=s[3],u=[];for(let r=0;r<m.length;r+=1)u[r]=ee(x(s,m,r));function g(r,a){return r[2]?de:he}let b=g(s),i=b(s);return{c(){e=k("select");for(let r=0;r<u.length;r+=1)u[r].c();n=v(`\r
\r
Selected breed: `),t=v(s[0]),l=B(),o=k("hr"),h=B(),i.c(),c=P(),this.h()},l(r){e=w(r,"SELECT",{name:!0,id:!0});var a=j(e);for(let f=0;f<u.length;f+=1)u[f].l(a);a.forEach(p),n=E(r,`\r
\r
Selected breed: `),t=E(r,s[0]),l=A(r),o=w(r,"HR",{"w-full":!0}),h=A(r),i.l(r),c=P(),this.h()},h(){$(e,"name",""),$(e,"id",""),s[0]===void 0&&J(()=>s[4].call(e)),$(o,"w-full","")},m(r,a){d(r,e,a);for(let f=0;f<u.length;f+=1)u[f]&&u[f].m(e,null);R(e,s[0],!0),d(r,n,a),d(r,t,a),d(r,l,a),d(r,o,a),d(r,h,a),i.m(r,a),d(r,c,a),_||(S=K(e,"change",s[4]),_=!0)},p(r,[a]){if(a&8){m=r[3];let f;for(f=0;f<m.length;f+=1){const D=x(r,m,f);u[f]?u[f].p(D,a):(u[f]=ee(D),u[f].c(),u[f].m(e,null))}for(;f<u.length;f+=1)u[f].d(1);u.length=m.length}a&9&&R(e,r[0]),a&1&&N(t,r[0]),b===(b=g(r))&&i?i.p(r,a):(i.d(1),i=b(r),i&&(i.c(),i.m(c.parentNode,c)))},i:y,o:y,d(r){r&&p(e),W(u,r),r&&p(n),r&&p(t),r&&p(l),r&&p(o),r&&p(h),i.d(r),r&&p(c),_=!1,S()}}}function _e(s,e,n){let t;const l=["affenpinscher","african","airedale"];let o,h=!1;function c(S){n(2,h=!1),n(1,o=null),fetch(`https://dog.ceo/api/breed/${S}/images/random`).then(m=>m.json()).then(m=>n(1,o=m.message)).catch(m=>n(2,h=!0))}function _(){t=X(this),n(0,t),n(3,l)}return s.$$.update=()=>{s.$$.dirty&1&&c(t)},[t,o,h,l,_]}class ge extends F{constructor(e){super(),O(this,e,_e,me,M,{})}}const be=`<script>\r
	let selectedBreed;\r
...
Selected breed: `),t=v(s[0]),l=B(),o=k("hr"),h=B(),i.c(),c=P(),this.h()},l(r){e=w(r,"SELECT",{name:!0,id:!0});var a=j(e);for(let f=0;f<u.length;f+=1)u[f].l(a);a.forEach(p),n=E(r,`\r
\r
Selected breed: `),t=E(r,s[0]),l=A(r),o=w(r,"HR",{"w-full":!0}),h=A(r),i.l(r),c=P(),this.h()},h(){$(e,"name",""),$(e,"id",""),s[0]===void 0&&J(()=>s[5].call(e)),$(o,"w-full","")},m(r,a){d(r,e,a);for(let f=0;f<u.length;f+=1)u[f]&&u[f].m(e,null);R(e,s[0],!0),d(r,n,a),d(r,t,a),d(r,l,a),d(r,o,a),d(r,h,a),i.m(r,a),d(r,c,a),_||(S=K(e,"change",s[5]),_=!0)},p(r,[a]){if(a&16){m=r[4];let f;for(f=0;f<m.length;f+=1){const D=te(r,m,f);u[f]?u[f].p(D,a):(u[f]=re(D),u[f].c(),u[f].m(e,null))}for(;f<u.length;f+=1)u[f].d(1);u.length=m.length}a&17&&R(e,r[0]),a&1&&N(t,r[0]),b===(b=g(r))&&i?i.p(r,a):(i.d(1),i=b(r),i&&(i.c(),i.m(c.parentNode,c)))},i:y,o:y,d(r){r&&p(e),W(u,r),r&&p(n),r&&p(t),r&&p(l),r&&p(o),r&&p(h),i.d(r),r&&p(c),_=!1,S()}}}function Ee(s,e,n){let t;const l=["affenpinscher","african","airedale"];let o,h=!1,c=!1;function _(m){n(2,h=!0),n(3,c=!1),n(1,o=null),fetch(`https://dog.ceo/api/breed/${m}/images/random`).then(u=>u.json()).then(u=>n(1,o=u.message)).catch(u=>n(3,c=!0)).finally(()=>n(2,h=!1))}function S(){t=X(this),n(0,t),n(4,l)}return s.$$.update=()=>{s.$$.dirty&1&&_(t)},[t,o,h,c,l,S]}class Se extends F{constructor(e){super(),O(this,e,Ee,ve,M,{})}}const ye=`<script>\r
	let selectedBreed;\r
	const breeds = ["affenpinscher", "african", "airedale"];\r
\r
	let imgSrc;\r
...
{:else}\r
	<img src={imgSrc} alt="dog" />\r
{/if}\r
`;function ne(s,e,n){const t=s.slice();return t[7]=e[n],t}function le(s){let e,n=s[7]+"",t;return{c(){e=k("option"),t=v(n),this.h()},l(l){e=w(l,"OPTION",{});var o=j(e);t=E(o,n),o.forEach(p),this.h()},h(){e.__value=s[7],e.value=e.__value},m(l,o){d(l,e,o),I(e,t)},p:y,d(l){l&&p(e)}}}function je(s){let e,n;return{c(){e=k("img"),this.h()},l(t){e=w(t,"IMG",{src:!0,alt:!0}),this.h()},h(){T(e.src,n=s[1])||$(e,"src",n),$(e,"alt","dog")},m(t,l){d(t,e,l)},p(t,l){l&2&&!T(e.src,n=t[1])&&$(e,"src",n)},d(t){t&&p(e)}}}function Ie(s){let e,n;return{c(){e=k("p"),n=v("loading...")},l(t){e=w(t,"P",{});var l=j(e);n=E(l,"loading..."),l.forEach(p)},m(t,l){d(t,e,l),I(e,n)},p:y,d(t){t&&p(e)}}}function Be(s){let e,n;return{c(){e=k("p"),n=v("oops! error!")},l(t){e=w(t,"P",{});var l=j(e);n=E(l,"oops! error!"),l.forEach(p)},m(t,l){d(t,e,l),I(e,n)},p:y,d(t){t&&p(e)}}}function Ae(s){let e,n,t,l,o,h,c,_,S,m=s[4],u=[];for(let r=0;r<m.length;r+=1)u[r]=le(ne(s,m,r));function g(r,a){return r[3]?Be:r[2]?Ie:je}let b=g(s),i=b(s);return{c(){e=k("select");for(let r=0;r<u.length;r+=1)u[r].c();n=v(`\r
\r
Selected breed: `),t=v(s[0]),l=B(),o=k("hr"),h=B(),i.c(),c=P(),this.h()},l(r){e=w(r,"SELECT",{name:!0,id:!0});var a=j(e);for(let f=0;f<u.length;f+=1)u[f].l(a);a.forEach(p),n=E(r,`\r
\r
Selected breed: `),t=E(r,s[0]),l=A(r),o=w(r,"HR",{"w-full":!0}),h=A(r),i.l(r),c=P(),this.h()},h(){$(e,"name",""),$(e,"id",""),s[0]===void 0&&J(()=>s[5].call(e)),$(o,"w-full","")},m(r,a){d(r,e,a);for(let f=0;f<u.length;f+=1)u[f]&&u[f].m(e,null);R(e,s[0],!0),d(r,n,a),d(r,t,a),d(r,l,a),d(r,o,a),d(r,h,a),i.m(r,a),d(r,c,a),_||(S=K(e,"change",s[5]),_=!0)},p(r,[a]){if(a&16){m=r[4];let f;for(f=0;f<m.length;f+=1){const D=ne(r,m,f);u[f]?u[f].p(D,a):(u[f]=le(D),u[f].c(),u[f].m(e,null))}for(;f<u.length;f+=1)u[f].d(1);u.length=m.length}a&17&&R(e,r[0]),a&1&&N(t,r[0]),b===(b=g(r))&&i?i.p(r,a):(i.d(1),i=b(r),i&&(i.c(),i.m(c.parentNode,c)))},i:y,o:y,d(r){r&&p(e),W(u,r),r&&p(n),r&&p(t),r&&p(l),r&&p(o),r&&p(h),i.d(r),r&&p(c),_=!1,S()}}}function De(s,e,n){let t;const l=["affenpinscher","african","airedale"];let o,h=!1,c=!1;async function _(m){try{n(2,h=!0),n(3,c=!1),n(1,o=null);const g=await(await fetch(`https://dog.ceo/api/breed/${m}/images/random`)).json();n(1,o=g.message)}catch{n(3,c=!0)}finally{n(2,h=!1)}}function S(){t=X(this),n(0,t),n(4,l)}return s.$$.update=()=>{s.$$.dirty&1&&_(t)},[t,o,h,c,l,S]}class Pe extends F{constructor(e){super(),O(this,e,De,Ae,M,{})}}const Re=`<script>\r
	let selectedBreed;\r
	const breeds = ["affenpinscher", "african", "airedale"];\r
\r
	let imgSrc;\r
