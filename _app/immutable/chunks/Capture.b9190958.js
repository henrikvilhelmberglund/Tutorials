import{S as H,i as S,s as q,q as k,k as m,r as d,l as g,m as h,h as c,b as f,D as _,P as v,H as $,T as J,y as T,z,A,g as C,d as P,B,C as F,E as G,F as Q,G as R,Q as K,e as I,R as L}from"./index.37298988.js";import{E as M}from"./Example.0a49acc8.js";function N(o){let s,e,t,n,a,l,i,b,r,x,E,y;return{c(){s=k(`Without |capture
`),e=m("div"),t=k(`Parent
...
`),r=g(W,"DIV",{});var w=h(r);x=d(w,"Child"),w.forEach(c),W.forEach(c)},m(p,u){f(p,s,u),f(p,e,u),_(e,t),_(e,n),_(n,a),f(p,l,u),f(p,i,u),_(i,b),_(i,r),_(r,x),E||(y=[v(n,"click",o[0]),v(e,"click",o[1]),v(r,"click",o[2]),v(i,"click",o[3],!0)],E=!0)},p:$,i:$,o:$,d(p){p&&c(s),p&&c(e),p&&c(l),p&&c(i),E=!1,J(y)}}}function O(o){return[()=>console.log("Child"),()=>console.log("Parent"),()=>console.log("Child"),()=>console.log("Parent")]}class U extends H{constructor(s){super(),S(this,s,O,N,q,{})}}const X=o=>({}),V=o=>({slot:"example"}),Y=o=>({}),j=o=>({slot:"code"});function Z(o){let s,e;return s=new U({}),{c(){T(s.$$.fragment)},l(t){z(s.$$.fragment,t)},m(t,n){A(s,t,n),e=!0},i(t){e||(C(s.$$.fragment,t),e=!0)},o(t){P(s.$$.fragment,t),e=!1},d(t){B(s,t)}}}function nn(o){let s;const e=o[0].default,t=F(e,o,o[1],V),n=t||Z();return{c(){n&&n.c()},l(a){n&&n.l(a)},m(a,l){n&&n.m(a,l),s=!0},p(a,l){t&&t.p&&(!s||l&2)&&G(t,e,a,a[1],s?R(e,a[1],l,X):Q(a[1]),V)},i(a){s||(C(n,a),s=!0)},o(a){P(n,a),s=!1},d(a){n&&n.d(a)}}}function an(o){let s,e=`Without |capture
