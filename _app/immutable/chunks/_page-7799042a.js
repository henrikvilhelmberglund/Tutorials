import{S as F,i as G,s as Q,k as V,q as d,a as C,l as X,m as ae,r as w,h as u,c as M,b as c,G as _e,Q as Y,u as ge,B as J,o as de,a7 as we,a8 as ce,j as ke,e as K,n as A,f as _,g as be,t as g,d as Ue,w as k,x as b,y as U,z as h,a9 as Oe,D as Re,M as ie,N as ze,O as Ae,P as je}from"./index-58af1356.js";import{M as qe,P as N}from"./mdsvex-layout-notes-a943bafe.js";import{S as Z}from"./ShowCode-978958bd.js";import{U as He}from"./Ul-d8f43016.js";import{L as me}from"./Li-5470a037.js";import{S as I}from"./Strong-d8efce91.js";function Le($){let e,t,o,l,s,m;return{c(){e=V("button"),t=d("Click me"),o=C(),l=d($[0])},l(n){e=X(n,"BUTTON",{});var f=ae(e);t=w(f,"Click me"),f.forEach(u),o=M(n),l=w(n,$[0])},m(n,f){c(n,e,f),_e(e,t),c(n,o,f),c(n,l,f),s||(m=Y(e,"click",$[2]),s=!0)},p(n,[f]){f&1&&ge(l,n[0])},i:J,o:J,d(n){n&&u(e),n&&u(o),n&&u(l),s=!1,m()}}}function We($,e,t){let o=0;de(()=>{console.log("onMount")}),we(()=>{console.log("onDestroy")}),ce(()=>{console.log("beforeUpdate")}),ke(()=>{console.log("afterUpdate")});function l(){t(0,o++,o)}return[o,l,()=>l()]}class Fe extends F{constructor(e){super(),G(this,e,We,Le,Q,{})}}function Ee($){let e,t;return e=new Fe({}),{c(){k(e.$$.fragment)},l(o){b(e.$$.fragment,o)},m(o,l){U(e,o,l),t=!0},i(o){t||(_(e.$$.fragment,o),t=!0)},o(o){g(e.$$.fragment,o),t=!1},d(o){h(e,o)}}}function Ge($){let e,t,o,l,s,m,n=$[0]&&Ee();return{c(){e=V("input"),t=C(),n&&n.c(),o=K(),this.h()},l(f){e=X(f,"INPUT",{type:!0,name:!0,id:!0}),t=M(f),n&&n.l(f),o=K(),this.h()},h(){A(e,"type","checkbox"),A(e,"name",""),A(e,"id","")},m(f,p){c(f,e,p),e.checked=$[0],c(f,t,p),n&&n.m(f,p),c(f,o,p),l=!0,s||(m=Y(e,"change",$[1]),s=!0)},p(f,[p]){p&1&&(e.checked=f[0]),f[0]?n?p&1&&_(n,1):(n=Ee(),n.c(),_(n,1),n.m(o.parentNode,o)):n&&(be(),g(n,1,1,()=>{n=null}),Ue())},i(f){l||(_(n),l=!0)},o(f){g(n),l=!1},d(f){f&&u(e),f&&u(t),n&&n.d(f),f&&u(o),s=!1,m()}}}function Qe($,e,t){let o;function l(){o=this.checked,t(0,o)}return[o,l]}class Ze extends F{constructor(e){super(),G(this,e,Qe,Ge,Q,{})}}const Je=`<script>\r
...
{#if condition}\r
	<Component />\r
{/if}\r
`;function Ke(){de(()=>{console.log("onMount")})}function Ve($){let e,t,o,l,s,m;return{c(){e=V("button"),t=d("Click me"),o=C(),l=d($[0])},l(n){e=X(n,"BUTTON",{});var f=ae(e);t=w(f,"Click me"),f.forEach(u),o=M(n),l=w(n,$[0])},m(n,f){c(n,e,f),_e(e,t),c(n,o,f),c(n,l,f),s||(m=Y(e,"click",$[2]),s=!0)},p(n,[f]){f&1&&ge(l,n[0])},i:J,o:J,d(n){n&&u(e),n&&u(o),n&&u(l),s=!1,m()}}}function Xe($,e,t){let o=0;Ke(),we(()=>{console.log("onDestroy")}),ce(()=>{console.log("beforeUpdate")}),ke(()=>{console.log("afterUpdate")});function l(){t(0,o++,o)}return[o,l,()=>l()]}class Ye extends F{constructor(e){super(),G(this,e,Xe,Ve,Q,{})}}function Pe($){let e,t;return e=new Ye({}),{c(){k(e.$$.fragment)},l(o){b(e.$$.fragment,o)},m(o,l){U(e,o,l),t=!0},i(o){t||(_(e.$$.fragment,o),t=!0)},o(o){g(e.$$.fragment,o),t=!1},d(o){h(e,o)}}}function et($){let e,t,o,l,s,m,n=$[0]&&Pe();return{c(){e=V("input"),t=C(),n&&n.c(),o=K(),this.h()},l(f){e=X(f,"INPUT",{type:!0,name:!0,id:!0}),t=M(f),n&&n.l(f),o=K(),this.h()},h(){A(e,"type","checkbox"),A(e,"name",""),A(e,"id","")},m(f,p){c(f,e,p),e.checked=$[0],c(f,t,p),n&&n.m(f,p),c(f,o,p),l=!0,s||(m=Y(e,"change",$[1]),s=!0)},p(f,[p]){p&1&&(e.checked=f[0]),f[0]?n?p&1&&_(n,1):(n=Pe(),n.c(),_(n,1),n.m(o.parentNode,o)):n&&(be(),g(n,1,1,()=>{n=null}),Ue())},i(f){l||(_(n),l=!0)},o(f){g(n),l=!1},d(f){f&&u(e),f&&u(t),n&&n.d(f),f&&u(o),s=!1,m()}}}function tt($,e,t){let o;function l(){o=this.checked,t(0,o)}return[o,l]}class nt extends F{constructor(e){super(),G(this,e,tt,et,Q,{})}}function ot(){let $=new Set;return ce(()=>{$.forEach(e=>{e.style.outlineColor="red",setTimeout(()=>{$.has(e)&&(e.style.outlineColor="black")},1e3)})}),de(()=>{$.forEach(e=>{e.style.outline="2px solid black",e.style.margin="8px"})}),function(t){return $.add(t),{destroy(){$.delete(t)}}}}function rt($){let e,t,o,l,s,m;return{c(){e=V("button"),t=d("Click me"),o=C(),l=d($[0])},l(n){e=X(n,"BUTTON",{});var f=ae(e);t=w(f,"Click me"),f.forEach(u),o=M(n),l=w(n,$[0])},m(n,f){c(n,e,f),_e(e,t),c(n,o,f),c(n,l,f),s||(m=[Oe($[1].call(null,e)),Y(e,"click",$[3])],s=!0)},p(n,[f]){f&1&&ge(l,n[0])},i:J,o:J,d(n){n&&u(e),n&&u(o),n&&u(l),s=!1,Re(m)}}}function st($,e,t){let o=0;const l=ot();we(()=>{console.log("onDestroy")}),ce(()=>{console.log("beforeUpdate")}),ke(()=>{console.log("afterUpdate")});function s(){t(0,o++,o)}return[o,l,s,()=>s()]}class ft extends F{constructor(e){super(),G(this,e,st,rt,Q,{})}}function xe($){let e,t;return e=new ft({}),{c(){k(e.$$.fragment)},l(o){b(e.$$.fragment,o)},m(o,l){U(e,o,l),t=!0},i(o){t||(_(e.$$.fragment,o),t=!0)},o(o){g(e.$$.fragment,o),t=!1},d(o){h(e,o)}}}function lt($){let e,t,o,l,s,m,n=$[0]&&xe();return{c(){e=V("input"),t=C(),n&&n.c(),o=K(),this.h()},l(f){e=X(f,"INPUT",{type:!0,name:!0,id:!0}),t=M(f),n&&n.l(f),o=K(),this.h()},h(){A(e,"type","checkbox"),A(e,"name",""),A(e,"id","")},m(f,p){c(f,e,p),e.checked=$[0],c(f,t,p),n&&n.m(f,p),c(f,o,p),l=!0,s||(m=Y(e,"change",$[1]),s=!0)},p(f,[p]){p&1&&(e.checked=f[0]),f[0]?n?p&1&&_(n,1):(n=xe(),n.c(),_(n,1),n.m(o.parentNode,o)):n&&(be(),g(n,1,1,()=>{n=null}),Ue())},i(f){l||(_(n),l=!0)},o(f){g(n),l=!1},d(f){f&&u(e),f&&u(t),n&&n.d(f),f&&u(o),s=!1,m()}}}function $t($,e,t){let o;function l(){o=this.checked,t(0,o)}return[o,l]}class pt extends F{constructor(e){super(),G(this,e,$t,lt,Q,{})}}const ut=`<script>\r
