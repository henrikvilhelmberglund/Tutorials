var x=Object.freeze,K=Object.defineProperty;var B=(o,s)=>x(K(o,"raw",{value:x(s||o.slice())}));import{S as N,i as O,s as z,k as $,q as k,a as E,l as v,m as w,r as f,h as u,c as j,b as i,G as S,Q as A,u as U,B as y,D as L,A as M,w as C,x as F,y as G,f as _,t as d,z as J,F as Q,H as R,I as V,J as W,R as P,e as H,T as X}from"./index-a6ce3bb5.js";import{E as Y}from"./Example-f263ece7.js";function Z(o){let s,e,t,n,a,c,m,r,g,b,h;return{c(){s=$("button"),e=k("-"),t=E(),n=k(o[0]),a=k(" * 2 = "),c=k(o[1]),m=E(),r=$("button"),g=k("+")},l(p){s=v(p,"BUTTON",{});var l=w(s);e=f(l,"-"),l.forEach(u),t=j(p),n=f(p,o[0]),a=f(p," * 2 = "),c=f(p,o[1]),m=j(p),r=v(p,"BUTTON",{});var T=w(r);g=f(T,"+"),T.forEach(u)},m(p,l){i(p,s,l),S(s,e),i(p,t,l),i(p,n,l),i(p,a,l),i(p,c,l),i(p,m,l),i(p,r,l),S(r,g),b||(h=[A(s,"click",o[3]),A(r,"click",o[2])],b=!0)},p(p,[l]){l&1&&U(n,p[0]),l&2&&U(c,p[1])},i:y,o:y,d(p){p&&u(s),p&&u(t),p&&u(n),p&&u(a),p&&u(c),p&&u(m),p&&u(r),b=!1,L(h)}}}function nn(o,s,e){let t,n=1;async function a(){e(0,n++,n),console.log("Before tick:"+t),await M(),console.log("After tick:"+t)}function c(){e(0,n--,n)}return o.$$.update=()=>{o.$$.dirty&1&&e(1,t=n*2)},[n,t,a,c]}class sn extends N{constructor(s){super(),O(this,s,nn,Z,z,{})}}const an=o=>({}),q=o=>({slot:"example"}),tn=o=>({}),D=o=>({slot:"code"});function en(o){let s,e;return s=new sn({}),{c(){C(s.$$.fragment)},l(t){F(s.$$.fragment,t)},m(t,n){G(s,t,n),e=!0},i(t){e||(_(s.$$.fragment,t),e=!0)},o(t){d(s.$$.fragment,t),e=!1},d(t){J(s,t)}}}function on(o){let s;const e=o[0].default,t=Q(e,o,o[1],q),n=t||en();return{c(){n&&n.c()},l(a){n&&n.l(a)},m(a,c){n&&n.m(a,c),s=!0},p(a,c){t&&t.p&&(!s||c&2)&&R(t,e,a,a[1],s?W(e,a[1],c,an):V(a[1]),q)},i(a){s||(_(n,a),s=!0)},o(a){d(n,a),s=!1},d(a){n&&n.d(a)}}}function pn(o){let s,e=`<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
{count} * 2 = {double}
<button on:click={increment}>+</button>`]))),meta:{Wrapper:"/src/lib/Example.svelte",example:!0},$$slots:{code:[cn],example:[on]},$$scope:{ctx:o}}}),{c(){s=$("div"),C(e.$$.fragment)},l(n){s=v(n,"DIV",{});var a=w(s);F(e.$$.fragment,a),a.forEach(u)},m(n,a){i(n,s,a),G(e,s,null),t=!0},p(n,[a]){const c={};a&2&&(c.$$scope={dirty:a,ctx:n}),e.$set(c)},i(n){t||(_(e.$$.fragment,n),t=!0)},o(n){d(e.$$.fragment,n),t=!1},d(n){n&&u(s),J(e)}}}function un(o,s,e){let{$$slots:t={},$$scope:n}=s;return o.$$set=a=>{"$$scope"in a&&e(1,n=a.$$scope)},[t,n]}class mn extends N{constructor(s){super(),O(this,s,un,ln,z,{})}}export{mn as default};
