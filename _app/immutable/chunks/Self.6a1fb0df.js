import{S as j,i as H,s as q,q as k,k as m,r as d,l as g,m as h,h as c,b as _,D as f,T as v,_ as J,H as $,Q as K,y as T,z,A,g as C,d as P,B,C as F,E as G,F as Q,G as U,U as L,e as V,V as M}from"./index.0b5cc0d7.js";import{E as N}from"./Example.18c27029.js";function O(l){let a,e,t,n,s,o,i,b,r,x,E,y;return{c(){a=k(`Without |self
`),e=m("div"),t=k(`Parent
...
`),r=g(W,"DIV",{});var D=h(r);x=d(D,"Child"),D.forEach(c),W.forEach(c)},m(p,u){_(p,a,u),_(p,e,u),f(e,t),f(e,n),f(n,s),_(p,o,u),_(p,i,u),f(i,b),f(i,r),f(r,x),E||(y=[v(n,"click",l[0]),v(e,"click",l[1]),v(r,"click",l[2]),v(i,"click",J(l[3]))],E=!0)},p:$,i:$,o:$,d(p){p&&c(a),p&&c(e),p&&c(o),p&&c(i),E=!1,K(y)}}}function R(l){return[()=>console.log("Child"),()=>console.log("Parent"),()=>console.log("Child"),()=>console.log("Parent")]}class X extends j{constructor(a){super(),H(this,a,R,O,q,{})}}const Y=l=>({}),I=l=>({slot:"example"}),Z=l=>({}),S=l=>({slot:"code"});function nn(l){let a,e;return a=new X({}),{c(){T(a.$$.fragment)},l(t){z(a.$$.fragment,t)},m(t,n){A(a,t,n),e=!0},i(t){e||(C(a.$$.fragment,t),e=!0)},o(t){P(a.$$.fragment,t),e=!1},d(t){B(a,t)}}}function sn(l){let a;const e=l[0].default,t=F(e,l,l[1],I),n=t||nn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,o){n&&n.m(s,o),a=!0},p(s,o){t&&t.p&&(!a||o&2)&&G(t,e,s,s[1],a?U(e,s[1],o,Y):Q(s[1]),I)},i(s){a||(C(n,s),a=!0)},o(s){P(n,s),a=!1},d(s){n&&n.d(s)}}}function an(l){let a,e=`Without |self
