import{S as v,i as g,s as y,k as $,q as u,l as b,m as P,r as d,h as m,p,b as h,D as c,u as x,H as f,I as w,a as X,c as Y,n as D,a4 as _,R as H,V as J,J as T,y as k,z as I,A as R,K,L as j,g as z,d as E,B as V,M as q}from"./index.5815ca79.js";import{M as Z,P as G}from"./mdsvex-layout-notes.7536afaf.js";import{r as B,d as C,w as Q}from"./index.522bc5dc.js";import{s as W}from"./index.4b5027c9.js";import{S as tt}from"./ShowMany.2af9ac15.js";class et extends v{constructor(t){super(),g(this,t,null,null,y,{})}}const nt=`<script>\r
...
`;function ft(o){return{subscribe:o.subscribe,set(){throw new Error("Unable to set the value of a readonly store")}}}function ht(o){let t,r,n,a,e;return{c(){t=$("input"),r=X(),n=$("input"),this.h()},l(s){t=b(s,"INPUT",{type:!0}),r=Y(s),n=b(s,"INPUT",{type:!0}),this.h()},h(){D(t,"type","text"),D(n,"type","text")},m(s,i){h(s,t,i),_(t,o[0]),h(s,r,i),h(s,n,i),_(n,o[1]),a||(e=[H(t,"input",o[4]),H(n,"input",o[5])],a=!0)},p(s,[i]){i&1&&t.value!==s[0]&&_(t,s[0]),i&2&&n.value!==s[1]&&_(n,s[1])},i:f,o:f,d(s){s&&m(t),s&&m(r),s&&m(n),a=!1,J(e)}}}function xt(o,t,r){let n,a,e=Q("");w(o,e,A=>r(0,n=A));let s=ft(e);w(o,s,A=>r(1,a=A));function i(){n=this.value,e.set(n)}function l(){a=this.value,s.set(a)}return[n,a,e,s,i,l]}class O extends v{constructor(t){super(),g(this,t,xt,ht,y,{})}}const vt=`<script>\r
	import mousePosition from "./mousePosition";\r
