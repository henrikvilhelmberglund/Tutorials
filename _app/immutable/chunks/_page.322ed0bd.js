...
`;function Ut(i){let e,s,t,o,r,a,n,u,f,_,k,O,l,p,b,y,S,K,z,Q,Z,Y;return{c(){e=m("div"),s=E(),t=m("div"),o=m("button"),r=h("0"),a=E(),n=m("button"),u=h("20"),f=E(),_=m("button"),k=h("40"),O=E(),l=m("button"),p=h("60"),b=E(),y=m("button"),S=h("80"),K=E(),z=m("button"),Q=h("100"),this.h()},l(x){e=v(x,"DIV",{style:!0}),$(e).forEach(c),s=N(x),t=v(x,"DIV",{class:!0});var T=$(t);o=v(T,"BUTTON",{});var tt=$(o);r=w(tt,"0"),tt.forEach(c),a=N(T),n=v(T,"BUTTON",{});var et=$(n);u=w(et,"20"),et.forEach(c),f=N(T),_=v(T,"BUTTON",{});var nt=$(_);k=w(nt,"40"),nt.forEach(c),O=N(T),l=v(T,"BUTTON",{});var rt=$(l);p=w(rt,"60"),rt.forEach(c),b=N(T),y=v(T,"BUTTON",{});var st=$(y);S=w(st,"80"),st.forEach(c),K=N(T),z=v(T,"BUTTON",{});var ot=$(z);Q=w(ot,"100"),ot.forEach(c),T.forEach(c),this.h()},h(){I(e,"height","50px"),I(e,"width","5px"),I(e,"background","red"),I(e,"transform-origin","left center"),I(e,"transform","scaleX("+i[0]+")"),H(t,"class","buttons svelte-zxcybq")},m(x,T){g(x,e,T),g(x,s,T),g(x,t,T),d(t,o),d(o,r),d(t,a),d(t,n),d(n,u),d(t,f),d(t,_),d(_,k),d(t,O),d(t,l),d(l,p),d(t,b),d(t,y),d(y,S),d(t,K),d(t,z),d(z,Q),Z||(Y=[C(o,"click",i[2]),C(n,"click",i[3]),C(_,"click",i[4]),C(l,"click",i[5]),C(y,"click",i[6]),C(z,"click",i[7])],Z=!0)},p(x,[T]){T&1&&I(e,"transform","scaleX("+x[0]+")")},i:U,o:U,d(x){x&&c(e),x&&c(s),x&&c(t),Z=!1,L(Y)}}}function zt(i,e,s){let t;const o=_t(1,{stiffness:.5,damping:.2});return W(i,o,k=>s(0,t=k)),[t,o,()=>o.set(0,{hard:!0}),()=>B(o,t=20,t),()=>B(o,t=40,t),()=>B(o,t=60,t),()=>B(o,t=80,t),()=>B(o,t=100,t)]}class It extends M{constructor(e){super(),P(this,e,zt,Ut,V,{})}}const Jt=`<script>\r
