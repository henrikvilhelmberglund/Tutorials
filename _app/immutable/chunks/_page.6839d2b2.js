import{S as y,i as B,s as U,k as S,q as d,a as O,l as L,m as N,r as C,c as T,h as m,p as F,b as _,D as E,T as I,H as q,al as tt,a0 as K,e as Q,n as R,g as w,v as it,d as k,f as ct,y as g,z as v,A as j,B as P,a2 as Z,u as z,am as et,Q as Ot,K as st,L as Tt,M as dt,N as Ct}from"./index.0b5cc0d7.js";import{M as Et,P as M}from"./mdsvex-layout-notes.c527e9b3.js";import{S as nt}from"./ShowMany.5b53376e.js";import{S as x}from"./Strong.272c5f79.js";function St(l){let t,n,r,s,e,i,o,p;return{c(){t=S("div"),n=d("Child "),r=d(l[0]),s=O(),e=S("button"),i=d("Click me"),this.h()},l(c){t=L(c,"DIV",{style:!0});var f=N(t);n=C(f,"Child "),r=C(f,l[0]),s=T(f),e=L(f,"BUTTON",{});var $=N(e);i=C($,"Click me"),$.forEach(m),f.forEach(m),this.h()},h(){F(t,"color",l[0])},m(c,f){_(c,t,f),E(t,n),E(t,r),E(t,s),E(t,e),E(e,i),o||(p=I(e,"click",l[1]),o=!0)},p:q,i:q,o:q,d(c){c&&m(t),o=!1,p()}}}function Lt(l){const t=tt("color");function n(r){K.call(this,l,r)}return[t,n]}class bt extends y{constructor(t){super(),B(this,t,Lt,St,U,{})}}function wt(l){let t,n,r,s;return t=new bt({}),t.$on("click",l[2]),r=new bt({}),r.$on("click",l[3]),{c(){g(t.$$.fragment),n=O(),g(r.$$.fragment)},l(e){v(t.$$.fragment,e),n=T(e),v(r.$$.fragment,e)},m(e,i){j(t,e,i),_(e,n,i),j(r,e,i),s=!0},i(e){s||(w(t.$$.fragment,e),w(r.$$.fragment,e),s=!0)},o(e){k(t.$$.fragment,e),k(r.$$.fragment,e),s=!1},d(e){P(t,e),e&&m(n),P(r,e)}}}function At(l){let t,n,r,s,e,i,o,p,c=l[0]&&wt(l);return{c(){t=S("label"),n=S("input"),r=d("Show"),s=O(),c&&c.c(),e=Q(),this.h()},l(f){t=L(f,"LABEL",{for:!0});var $=N(t);n=L($,"INPUT",{type:!0}),r=C($,"Show"),$.forEach(m),s=T(f),c&&c.l(f),e=Q(),this.h()},h(){R(n,"type","checkbox"),R(t,"for","")},m(f,$){_(f,t,$),E(t,n),n.checked=l[0],E(t,r),_(f,s,$),c&&c.m(f,$),_(f,e,$),i=!0,o||(p=I(n,"change",l[1]),o=!0)},p(f,[$]){$&1&&(n.checked=f[0]),f[0]?c?$&1&&w(c,1):(c=wt(f),c.c(),w(c,1),c.m(e.parentNode,e)):c&&(it(),k(c,1,1,()=>{c=null}),ct())},i(f){i||(w(c),i=!0)},o(f){k(c),i=!1},d(f){f&&m(t),f&&m(s),c&&c.d(f),f&&m(e),o=!1,p()}}}function Nt(l,t,n){let r=!0;function s(){r=this.checked,n(0,r)}function e(o){K.call(this,l,o)}function i(o){K.call(this,l,o)}return[r,s,e,i]}class It extends y{constructor(t){super(),B(this,t,Nt,At,U,{})}}function yt(l){let t,n,r,s,e,i,o,p,c,f;return e=new It({}),e.$on("click",l[2]),{c(){t=S("input"),n=O(),r=d(l[0]),s=O(),g(e.$$.fragment),i=d(`\r
\r
Count: `),o=d(l[1]),this.h()},l($){t=L($,"INPUT",{type:!0}),n=T($),r=C($,l[0]),s=T($),v(e.$$.fragment,$),i=C($,`\r
\r
Count: `),o=C($,l[1]),this.h()},h(){R(t,"type","color")},m($,a){_($,t,a),Z(t,l[0]),_($,n,a),_($,r,a),_($,s,a),j(e,$,a),_($,i,a),_($,o,a),p=!0,c||(f=I(t,"input",l[3]),c=!0)},p($,[a]){a&1&&Z(t,$[0]),(!p||a&1)&&z(r,$[0]),(!p||a&2)&&z(o,$[1])},i($){p||(w(e.$$.fragment,$),p=!0)},o($){k(e.$$.fragment,$),p=!1},d($){$&&m(t),$&&m(n),$&&m(r),$&&m(s),P(e,$),$&&m(i),$&&m(o),c=!1,f()}}}function Bt(l,t,n){let r="red",s=0;et("color",r);function e(){n(1,s++,s)}function i(){r=this.value,n(0,r)}return[r,s,e,i]}class rt extends y{constructor(t){super(),B(this,t,Bt,yt,U,{})}}const Ut=`<script>\r
...
`;function Ft(l){let t,n,r,s,e,i,o,p,c,f,$;return{c(){t=S("div"),n=d("Child "),r=d(l[0]),s=O(),e=S("button"),i=d("Click me +1"),o=O(),p=S("button"),c=d("Click me +2"),this.h()},l(a){t=L(a,"DIV",{style:!0});var h=N(t);n=C(h,"Child "),r=C(h,l[0]),s=T(h),e=L(h,"BUTTON",{});var V=N(e);i=C(V,"Click me +1"),V.forEach(m),o=T(h),p=L(h,"BUTTON",{});var A=N(p);c=C(A,"Click me +2"),A.forEach(m),h.forEach(m),this.h()},h(){F(t,"color",l[0])},m(a,h){_(a,t,h),E(t,n),E(t,r),E(t,s),E(t,e),E(e,i),E(t,o),E(t,p),E(p,c),f||($=[I(e,"click",l[2]),I(p,"click",l[3])],f=!0)},p(a,[h]){h&1&&z(r,a[0]),h&1&&F(t,"color",a[0])},i:q,o:q,d(a){a&&m(t),f=!1,Ot($)}}}function Gt(l,t,n){const r=tt("color");let s=r.color;r.listenToColorChange(p=>n(0,s=p));const e=tt("click");return[s,e,()=>e(1),()=>e(2)]}class vt extends y{constructor(t){super(),B(this,t,Gt,Ft,U,{})}}function jt(l){let t,n,r,s;return t=new vt({}),r=new vt({}),{c(){g(t.$$.fragment),n=O(),g(r.$$.fragment)},l(e){v(t.$$.fragment,e),n=T(e),v(r.$$.fragment,e)},m(e,i){j(t,e,i),_(e,n,i),j(r,e,i),s=!0},i(e){s||(w(t.$$.fragment,e),w(r.$$.fragment,e),s=!0)},o(e){k(t.$$.fragment,e),k(r.$$.fragment,e),s=!1},d(e){P(t,e),e&&m(n),P(r,e)}}}function Jt(l){let t,n,r,s,e,i,o,p,c=l[0]&&jt();return{c(){t=S("label"),n=S("input"),r=d("Show"),s=O(),c&&c.c(),e=Q(),this.h()},l(f){t=L(f,"LABEL",{for:!0});var $=N(t);n=L($,"INPUT",{type:!0}),r=C($,"Show"),$.forEach(m),s=T(f),c&&c.l(f),e=Q(),this.h()},h(){R(n,"type","checkbox"),R(t,"for","")},m(f,$){_(f,t,$),E(t,n),n.checked=l[0],E(t,r),_(f,s,$),c&&c.m(f,$),_(f,e,$),i=!0,o||(p=I(n,"change",l[1]),o=!0)},p(f,[$]){$&1&&(n.checked=f[0]),f[0]?c?$&1&&w(c,1):(c=jt(),c.c(),w(c,1),c.m(e.parentNode,e)):c&&(it(),k(c,1,1,()=>{c=null}),ct())},i(f){i||(w(c),i=!0)},o(f){k(c),i=!1},d(f){f&&m(t),f&&m(s),c&&c.d(f),f&&m(e),o=!1,p()}}}function Xt(l,t,n){let r=!0;function s(){r=this.checked,n(0,r)}return[r,s]}class Yt extends y{constructor(t){super(),B(this,t,Xt,Jt,U,{})}}function te(l){let t,n,r=l[0].color+"",s,e,i,o,p,c,f,$;return i=new Yt({}),{c(){t=S("input"),n=O(),s=d(r),e=O(),g(i.$$.fragment),o=d(`\r
\r
Count: `),p=d(l[1]),this.h()},l(a){t=L(a,"INPUT",{type:!0}),n=T(a),s=C(a,r),e=T(a),v(i.$$.fragment,a),o=C(a,`\r
\r
Count: `),p=C(a,l[1]),this.h()},h(){R(t,"type","color")},m(a,h){_(a,t,h),Z(t,l[0].color),_(a,n,h),_(a,s,h),_(a,e,h),j(i,a,h),_(a,o,h),_(a,p,h),c=!0,f||($=I(t,"input",l[2]),f=!0)},p(a,[h]){h&1&&Z(t,a[0].color),(!c||h&1)&&r!==(r=a[0].color+"")&&z(s,r),(!c||h&2)&&z(p,a[1])},i(a){c||(w(i.$$.fragment,a),c=!0)},o(a){k(i.$$.fragment,a),c=!1},d(a){a&&m(t),a&&m(n),a&&m(s),a&&m(e),P(i,a),a&&m(o),a&&m(p),f=!1,$()}}}function ee(l,t,n){let r=0;const s=new Set;let e={color:"red",listenToColorChange(p){s.add(p)}};et("color",e),et("click",i);function i(p){n(1,r+=p)}function o(){e.color=this.value,n(0,e)}return l.$$.update=()=>{l.$$.dirty&1&&s.forEach(p=>p(e.color))},[e,r,o]}class lt extends y{constructor(t){super(),B(this,t,ee,te,U,{})}}const ne=`<script>\r
