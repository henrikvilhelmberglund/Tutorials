import{S as h,i as $,s as k,k as _,q as u,l as d,m as w,r as f,h as l,b as p,D as v,u as b,H as m,o as g,I as M,J as S,y as C,z as x,A as y,K,L as j,g as I,d as A,B as D,M as H,a as B,c as N}from"./index.37298988.js";import{M as L,P as O}from"./mdsvex-layout-notes.28d092d4.js";import{w as R}from"./index.646636c1.js";import{S as T}from"./ShowMany.1ce9c697.js";let J=class{constructor(){this.time=Date.now(),this.subscribers=[]}tick(){this.time=Date.now(),this.subscribers.forEach(t=>{t(this)})}subscribe(t){return t(this),this.subscribers.push(t),()=>{this.subscribers.splice(this.subscribers.indexOf(t))}}};function Z(s){let t,n;return{c(){t=_("p"),n=u(s[0])},l(e){t=d(e,"P",{});var r=w(t);n=f(r,s[0]),r.forEach(l)},m(e,r){p(e,t,r),v(t,n)},p(e,[r]){r&1&&b(n,e[0])},i:m,o:m,d(e){e&&l(t)}}}function G(s,t,n){const e=new J;g(()=>{let o=setInterval(()=>{e.tick()},1e3);return()=>clearInterval(o)});let r;return s.$$.update=()=>{s.$$.dirty&1&&(n(0,r=e.time),console.log("time",r))},[r]}class Q extends h{constructor(t){super(),$(this,t,G,Z,k,{})}}const V=`<script>\r
