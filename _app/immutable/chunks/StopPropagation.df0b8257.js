import{S as q,i as B,s as R,q as _,k as m,a as K,r as d,l as g,m as h,h as c,c as L,b as r,D as f,P,Z as M,H as C,T as N,y as T,z,A,g as b,d as x,B as F,C as G,E as Q,F as Z,G as J,Q as O,e as V,R as U}from"./index.37298988.js";import{E as X}from"./Example.0a49acc8.js";function Y(e){let s,o,t,n,a,l,v,$,u,E,k,W,y,D;return{c(){s=_(`Without |stopPropagation
`),o=m("div"),t=_(`Parent
...
`),k=g(w,"DIV",{});var S=h(k);W=d(S,"Child"),S.forEach(c),w.forEach(c)},m(p,i){r(p,s,i),r(p,o,i),f(o,t),f(o,n),f(n,a),r(p,l,i),r(p,v,i),r(p,$,i),r(p,u,i),f(u,E),f(u,k),f(k,W),y||(D=[P(n,"click",e[0]),P(o,"click",e[1]),P(k,"click",M(e[2])),P(u,"click",e[3])],y=!0)},p:C,i:C,o:C,d(p){p&&c(s),p&&c(o),p&&c(l),p&&c(v),p&&c($),p&&c(u),y=!1,N(D)}}}function nn(e){return[()=>console.log("Child"),()=>console.log("Parent"),()=>console.log("Child"),()=>console.log("Parent")]}class an extends q{constructor(s){super(),B(this,s,nn,Y,R,{})}}const sn=e=>({}),j=e=>({slot:"example"}),tn=e=>({}),H=e=>({slot:"code"});function on(e){let s,o;return s=new an({}),{c(){T(s.$$.fragment)},l(t){z(s.$$.fragment,t)},m(t,n){A(s,t,n),o=!0},i(t){o||(b(s.$$.fragment,t),o=!0)},o(t){x(s.$$.fragment,t),o=!1},d(t){F(s,t)}}}function en(e){let s;const o=e[0].default,t=G(o,e,e[1],j),n=t||on();return{c(){n&&n.c()},l(a){n&&n.l(a)},m(a,l){n&&n.m(a,l),s=!0},p(a,l){t&&t.p&&(!s||l&2)&&Q(t,o,a,a[1],s?J(o,a[1],l,sn):Z(a[1]),j)},i(a){s||(b(n,a),s=!0)},o(a){x(n,a),s=!1},d(a){n&&n.d(a)}}}function pn(e){let s,o=`Without |stopPropagation
