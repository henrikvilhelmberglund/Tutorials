import{S as D,i as P,s as S,k as $,a as I,q as g,l as v,c as T,m as y,r as b,h as d,n as w,b as _,D as h,T as K,u as V,H as A,ad as ot,ai as ct,e as j,v as ut,d as C,f as ft,g as E,a2 as W,J,y as F,z,A as L,B as N,a5 as pt,O as M,K as H,L as _t,M as Z,N as G}from"./index.0b5cc0d7.js";import{M as ht,P as Q}from"./mdsvex-layout-notes.c527e9b3.js";import{f as dt}from"./index.0f4f1c76.js";import{S as X}from"./ShowMany.5b53376e.js";import{S as $t}from"./ShowCode.1ad00a73.js";import{S as R}from"./Strong.272c5f79.js";function vt(i){let t,e,n,l,c,u;return{c(){t=$("input"),e=I(),n=$("button"),l=g(i[0]),this.h()},l(a){t=v(a,"INPUT",{type:!0}),e=T(a),n=v(a,"BUTTON",{});var o=y(n);l=b(o,i[0]),o.forEach(d),this.h()},h(){w(t,"type","text")},m(a,o){_(a,t,o),_(a,e,o),_(a,n,o),h(n,l),c||(u=K(n,"click",i[1]),c=!0)},p(a,[o]){o&1&&V(l,a[0])},i:A,o:A,d(a){a&&d(t),a&&d(e),a&&d(n),c=!1,u()}}}function gt(i,t,e){let n=0;return[n,()=>e(0,n++,n)]}class bt extends D{constructor(t){super(),P(this,t,gt,vt,S,{})}}const kt=`<script>\r
	let count = 0;\r
<\/script>\r
\r
<input type="text" />\r
...
\r
<button on:click={() => count++}>{count}</button>\r
`;function It(i){let t,e,n,l,c,u,a,o,f,p;return{c(){t=$("input"),e=I(),n=$("button"),l=g(i[0]),c=I(),u=$("div"),a=g(i[0]),this.h()},l(r){t=v(r,"INPUT",{type:!0}),e=T(r),n=v(r,"BUTTON",{});var s=y(n);l=b(s,i[0]),s.forEach(d),c=T(r),u=v(r,"DIV",{});var m=y(u);a=b(m,i[0]),m.forEach(d),this.h()},h(){w(t,"type","text")},m(r,s){_(r,t,s),_(r,e,s),_(r,n,s),h(n,l),_(r,c,s),_(r,u,s),h(u,a),f||(p=K(n,"click",i[1]),f=!0)},p(r,[s]){s&1&&V(l,r[0]),s&1&&V(a,r[0])},i(r){o||ot(()=>{o=ct(u,dt,{}),o.start()})},o:A,d(r){r&&d(t),r&&d(e),r&&d(n),r&&d(c),r&&d(u),f=!1,p()}}}function Tt(i,t,e){let n=0;return[n,()=>e(0,n++,n)]}class Ft extends D{constructor(t){super(),P(this,t,Tt,It,S,{})}}const zt=`<script>\r
