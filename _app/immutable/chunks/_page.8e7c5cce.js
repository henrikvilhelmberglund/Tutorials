import{S as T,i as S,s as I,k as H,a as y,q as c,l as M,c as A,m as R,h as m,r as $,b as f,a2 as b,P as U,aa as V,W as j,u as B,H as L,T as C,J as k,y as _,z as d,A as w,K,L as z,g as h,d as g,B as v,M as q}from"./index.37298988.js";import{M as W,P as E}from"./mdsvex-layout-notes.28d092d4.js";import{S as N}from"./ShowMany.1ce9c697.js";import{S as J}from"./Strong.b6d58cbc.js";function Z(o){let t,a,r,l,n,s,u,p;return{c(){t=H("input"),a=y(),r=H("div"),n=c(`\r
\r
name: `),s=c(o[0])},l(e){t=M(e,"INPUT",{}),a=A(e),r=M(e,"DIV",{}),R(r).forEach(m),n=$(e,`\r
\r
name: `),s=$(e,o[0])},m(e,i){f(e,t,i),b(t,o[0]),f(e,a,i),f(e,r,i),f(e,n,i),f(e,s,i),u||(p=[U(t,"input",o[1]),V(l=F.call(null,r,o[0]))],u=!0)},p(e,[i]){i&1&&t.value!==e[0]&&b(t,e[0]),l&&j(l.update)&&i&1&&l.update.call(null,e[0]),i&1&&B(s,e[0])},i:L,o:L,d(e){e&&m(t),e&&m(a),e&&m(r),e&&m(n),e&&m(s),u=!1,C(p)}}}function F(o,t){return console.log(o,t),o.innerHTML=t,{destroy(){console.log("node was destroyed")}}}function G(o,t,a){let r="world";function l(){r=this.value,a(0,r)}return[r,l]}class Q extends T{constructor(t){super(),S(this,t,G,Z,I,{})}}const X=`<script>\r
	let name = "world";\r
\r
