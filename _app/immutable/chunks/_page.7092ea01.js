import{S as h,i as $,s as k,k as _,q as u,l as d,m as w,r as f,h as l,b as p,D as v,u as b,H as m,o as g,I as M,K as S,y as C,z as x,A as y,L,M as j,g as I,d as A,B as D,N as H,a as N,c as B}from"./index.0b5cc0d7.js";import{M as T,P as O}from"./mdsvex-layout-notes.c527e9b3.js";import{w as R}from"./index.153ae70b.js";import{S as Z}from"./ShowMany.5b53376e.js";let K=class{constructor(){this.time=Date.now(),this.subscribers=[]}tick(){this.time=Date.now(),this.subscribers.forEach(t=>{t(this)})}subscribe(t){return t(this),this.subscribers.push(t),()=>{this.subscribers.splice(this.subscribers.indexOf(t))}}};function G(s){let t,n;return{c(){t=_("p"),n=u(s[0])},l(e){t=d(e,"P",{});var r=w(t);n=f(r,s[0]),r.forEach(l)},m(e,r){p(e,t,r),v(t,n)},p(e,[r]){r&1&&b(n,e[0])},i:m,o:m,d(e){e&&l(t)}}}function J(s,t,n){const e=new K;g(()=>{let o=setInterval(()=>{e.tick()},1e3);return()=>clearInterval(o)});let r;return s.$$.update=()=>{s.$$.dirty&1&&(n(0,r=e.time),console.log("time",r))},[r]}class Q extends h{constructor(t){super(),$(this,t,J,G,k,{})}}const V=`<script>\r
...
\r
<p>{time}</p>\r
`;function X(s){let t,n;return{c(){t=_("p"),n=u(s[0])},l(e){t=d(e,"P",{});var r=w(t);n=f(r,s[0]),r.forEach(l)},m(e,r){p(e,t,r),v(t,n)},p(e,[r]){r&1&&b(n,e[0])},i:m,o:m,d(e){e&&l(t)}}}function Y(s,t,n){let e;const r=new K;M(s,r,c=>n(2,e=c)),g(()=>{let c=setInterval(()=>{r.tick()},1e3);return()=>clearInterval(c)});let o;return s.$$.update=()=>{s.$$.dirty&5&&(n(0,o=e.time),console.log("time",o))},[o,r,e]}class W extends h{constructor(t){super(),$(this,t,Y,X,k,{})}}const tt=`<script>\r
	import { onMount } from "svelte";\r
	import Clock from "./clock";\r
\r
	const clock = new Clock();\r
...
\r
export default Clock;\r
`;function _t(s){let t;return{c(){t=u("How can we turn a class property into a store? By default class properties do not give reactivity unless the class itself changes somehow.")},l(n){t=f(n,"How can we turn a class property into a store? By default class properties do not give reactivity unless the class itself changes somehow.")},m(n,e){p(n,t,e)},d(n){n&&l(t)}}}function dt(s){let t;return{c(){t=u("Which one is the best? Uh… I'll get back to you!")},l(n){t=f(n,"Which one is the best? Uh… I'll get back to you!")},m(n,e){p(n,t,e)},d(n){n&&l(t)}}}function wt(s){let t,n,e,r,o,c;return t=new O({props:{$$slots:{default:[_t]},$$scope:{ctx:s}}}),e=new Z({props:{name:[{name:"NotAnApp",comp:Q,raw:V,text:"Here we can see that the console.log() doesn't trigger."},{name:"App",comp:W,raw:tt,text:"One method is to use create a store from the class and use $clock.time."},{name:"clock.js",comp:W,raw:ft,text:""},{name:"App2",comp:q,raw:st,text:"We can simplify this further by using a writable store."},{name:"clock2.js",comp:q,raw:ht,text:""},{name:"App3",comp:U,raw:lt,text:"Another method is to use create a store from the property and use $timeStore."},{name:"clock3.js",comp:U,raw:$t,text:""},{name:"App4",comp:z,raw:ut,text:"Finally we can have a private store."},{name:"clock4.js",comp:z,raw:kt,text:""}]}}),o=new O({props:{$$slots:{default:[dt]},$$scope:{ctx:s}}}),{c(){C(t.$$.fragment),n=N(),C(e.$$.fragment),r=N(),C(o.$$.fragment)},l(i){x(t.$$.fragment,i),n=B(i),x(e.$$.fragment,i),r=B(i),x(o.$$.fragment,i)},m(i,a){y(t,i,a),p(i,n,a),y(e,i,a),p(i,r,a),y(o,i,a),c=!0},p(i,a){const E={};a&2&&(E.$$scope={dirty:a,ctx:i}),t.$set(E);const P={};a&2&&(P.$$scope={dirty:a,ctx:i}),o.$set(P)},i(i){c||(I(t.$$.fragment,i),I(e.$$.fragment,i),I(o.$$.fragment,i),c=!0)},o(i){A(t.$$.fragment,i),A(e.$$.fragment,i),A(o.$$.fragment,i),c=!1},d(i){D(t,i),i&&l(n),D(e,i),i&&l(r),D(o,i)}}}function vt(s){let t,n;const e=[s[0],F];let r={$$slots:{default:[wt]},$$scope:{ctx:s}};for(let o=0;o<e.length;o+=1)r=S(r,e[o]);return t=new T({props:r}),{c(){C(t.$$.fragment)},l(o){x(t.$$.fragment,o)},m(o,c){y(t,o,c),n=!0},p(o,[c]){const i=c&1?L(e,[c&1&&j(o[0]),c&0&&j(F)]):{};c&2&&(i.$$scope={dirty:c,ctx:o}),t.$set(i)},i(o){n||(I(t.$$.fragment,o),n=!0)},o(o){A(t.$$.fragment,o),n=!1},d(o){D(t,o)}}}const F={title:"Reactive class property using stores",author:"henrikvilhelmberglund",authorlink:"github.com/henrikvilhelmberglund/",date:"2023-03-28T00:00:00.000Z",layout:"notes"};function bt(s,t,n){return s.$$set=e=>{n(0,t=S(S({},t),H(e)))},t=H(t),[t]}class Mt extends h{constructor(t){super(),$(this,t,bt,vt,k,{})}}export{Mt as default,F as metadata};
