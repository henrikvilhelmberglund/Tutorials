import{S as D,i as L,s as q,k as U,l as C,b as m,P as ut,H as B,h as a,q as c,a as R,m as G,r as _,c as S,D as y,u as V,o as Bt,y as b,z as h,A as v,g as I,d as T,B as O,I as X,ap as ct,J as pt,K as Pt,L as Ht,M as yt}from"./index.37298988.js";import{M as Ut,P as W}from"./mdsvex-layout-notes.28d092d4.js";import{r as _t,w as wt}from"./index.646636c1.js";import{S as at}from"./ShowMany.1ce9c697.js";import{U as Et}from"./Ul.7c7d0e94.js";import{H as Ct}from"./H3.51a842fb.js";import{S as E}from"./Strong.b6d58cbc.js";import{L as F}from"./Li.9fb82923.js";let Nt=_t(0,f=>{let e=0,t=setInterval(()=>{f(e++)},1e3);return()=>{clearTimeout(t)}});const jt=wt("");function Wt(f){let e,t,n;return{c(){e=U("input")},l($){e=C($,"INPUT",{})},m($,s){m($,e,s),t||(n=ut(e,"input",f[0]),t=!0)},p:B,i:B,o:B,d($){$&&a(e),t=!1,n()}}}function Dt(f){return[t=>jt.set(t.currentTarget.value)]}class Lt extends D{constructor(e){super(),L(this,e,Dt,Wt,q,{})}}function qt(f){let e,t,n,$,s,l,r;return{c(){e=U("h1"),t=c("store1: "),n=c(f[0]),$=R(),s=U("h1"),l=c("store2: "),r=c(f[1])},l(p){e=C(p,"H1",{});var u=G(e);t=_(u,"store1: "),n=_(u,f[0]),u.forEach(a),$=S(p),s=C(p,"H1",{});var g=G(s);l=_(g,"store2: "),r=_(g,f[1]),g.forEach(a)},m(p,u){m(p,e,u),y(e,t),y(e,n),m(p,$,u),m(p,s,u),y(s,l),y(s,r)},p(p,[u]){u&1&&V(n,p[0]),u&2&&V(r,p[1])},i:B,o:B,d(p){p&&a(e),p&&a($),p&&a(s)}}}function Yt(f,e,t){let n,$;return Bt(()=>Nt.subscribe(s=>{t(0,n=s)})),Bt(()=>jt.subscribe(s=>{t(1,$=s)})),[n,$]}class zt extends D{constructor(e){super(),L(this,e,Yt,qt,q,{})}}function Jt(f){let e,t,n,$;return e=new Lt({}),n=new zt({}),{c(){b(e.$$.fragment),t=R(),b(n.$$.fragment)},l(s){h(e.$$.fragment,s),t=S(s),h(n.$$.fragment,s)},m(s,l){v(e,s,l),m(s,t,l),v(n,s,l),$=!0},p:B,i(s){$||(I(e.$$.fragment,s),I(n.$$.fragment,s),$=!0)},o(s){T(e.$$.fragment,s),T(n.$$.fragment,s),$=!1},d(s){O(e,s),s&&a(t),O(n,s)}}}class $t extends D{constructor(e){super(),L(this,e,null,Jt,q,{})}}const Kt=`<script>\r
...
\r
export const store2 = writable("");`;let ue=_t(0,f=>{let e=0,t=setInterval(()=>{f(e++)},1e3);return()=>{clearTimeout(t)}});const it=wt("");function ae(f){let e,t,n;return{c(){e=U("input")},l($){e=C($,"INPUT",{})},m($,s){m($,e,s),t||(n=ut(e,"input",f[1]),t=!0)},p:B,i:B,o:B,d($){$&&a(e),t=!1,n()}}}function pe(f,e,t){let n;return X(f,it,s=>t(0,n=s)),[n,s=>ct(it,n=s.currentTarget.value,n)]}class me extends D{constructor(e){super(),L(this,e,pe,ae,q,{})}}function ie(f){let e,t,n,$,s,l,r,p,u,g,i,x,d,M,H,N;return{c(){e=U("h1"),t=c("store1: "),n=c(f[0]),$=R(),s=U("h1"),l=c("store2: "),r=c(f[1]),p=R(),u=U("h1"),g=c("store3: "),i=c(f[2]),x=R(),d=U("button"),M=c("Click me!")},l(k){e=C(k,"H1",{});var A=G(e);t=_(A,"store1: "),n=_(A,f[0]),A.forEach(a),$=S(k),s=C(k,"H1",{});var j=G(s);l=_(j,"store2: "),r=_(j,f[1]),j.forEach(a),p=S(k),u=C(k,"H1",{});var Y=G(u);g=_(Y,"store3: "),i=_(Y,f[2]),Y.forEach(a),x=S(k),d=C(k,"BUTTON",{});var P=G(d);M=_(P,"Click me!"),P.forEach(a)},m(k,A){m(k,e,A),y(e,t),y(e,n),m(k,$,A),m(k,s,A),y(s,l),y(s,r),m(k,p,A),m(k,u,A),y(u,g),y(u,i),m(k,x,A),m(k,d,A),y(d,M),H||(N=ut(d,"click",f[4]),H=!0)},p(k,[A]){A&1&&V(n,k[0]),A&2&&V(r,k[1]),A&4&&V(i,k[2])},i:B,o:B,d(k){k&&a(e),k&&a($),k&&a(s),k&&a(p),k&&a(u),k&&a(x),k&&a(d),H=!1,N()}}}function ce(f,e,t){let n,$,s;X(f,ue,u=>t(0,n=u)),X(f,it,u=>t(1,$=u));const l=[];setInterval(()=>{for(const u of l)u(+new Date)},1e3);const r={subscribe(u){return u(""),l.push(u),()=>{l.splice(l.indexOf(u),1)}},set(u){for(const g of l)g(u)}};return X(f,r,u=>t(2,s=u)),[n,$,s,r,()=>ct(r,s="hello",s)]}class _e extends D{constructor(e){super(),L(this,e,ce,ie,q,{})}}function we(f){let e,t,n,$;return e=new me({}),n=new _e({}),{c(){b(e.$$.fragment),t=R(),b(n.$$.fragment)},l(s){h(e.$$.fragment,s),t=S(s),h(n.$$.fragment,s)},m(s,l){v(e,s,l),m(s,t,l),v(n,s,l),$=!0},p:B,i(s){$||(I(e.$$.fragment,s),I(n.$$.fragment,s),$=!0)},o(s){T(e.$$.fragment,s),T(n.$$.fragment,s),$=!1},d(s){O(e,s),s&&a(t),O(n,s)}}}class lt extends D{constructor(e){super(),L(this,e,null,we,q,{})}}const ge=`<script>\r
