import{S as F,i as Q,s as U,k as j,a as y,q as _,l as H,m as M,h as l,c as h,r as v,p as b,n as B,b as p,D as Y,ac as G,R as J,H as C,V as ee,J as q,y as x,z as I,A as k,K as te,L as K,g as E,d as A,B as z,M as T}from"./index.5815ca79.js";import{M as ne,P as W}from"./mdsvex-layout-notes.7536afaf.js";import{S as re}from"./ShowMany.2af9ac15.js";import{b as oe}from"./paths.3baf5e07.js";import{S as R}from"./Strong.b8abec16.js";let P;function se(){P||(P=new IntersectionObserver(a=>{a.forEach(e=>{const t=e.isIntersecting?"enterViewport":"exitViewport";e.target.dispatchEvent(new CustomEvent(t))})}))}function X(a){return se(),P.observe(a),{destroy(){P.unobserve(a)}}}function ie(a){const e=X(a);a.addEventListener("enterViewport",t);function t(){a.src=a.dataset.src,a.removeEventListener("enterViewport",t)}return{destroy(){e.destroy(),a.removeEventListener("enterViewport",t)}}}function ae(a){let e,t,i,u,n,f,o,$,c,V,d,g,r,m,L,O,S,D;return{c(){e=j("div"),t=y(),i=j("div"),u=y(),n=j("div"),f=y(),o=j("img"),$=y(),c=j("h1"),V=_("Hello world!"),d=y(),g=j("div"),r=y(),m=j("div"),L=y(),O=j("div"),this.h()},l(s){e=H(s,"DIV",{style:!0}),M(e).forEach(l),t=h(s),i=H(s,"DIV",{style:!0}),M(i).forEach(l),u=h(s),n=H(s,"DIV",{style:!0}),M(n).forEach(l),f=h(s),o=H(s,"IMG",{"data-src":!0,alt:!0}),$=h(s),c=H(s,"H1",{});var w=M(c);V=v(w,"Hello world!"),w.forEach(l),d=h(s),g=H(s,"DIV",{style:!0}),M(g).forEach(l),r=h(s),m=H(s,"DIV",{style:!0}),M(m).forEach(l),L=h(s),O=H(s,"DIV",{style:!0}),M(O).forEach(l),this.h()},h(){b(e,"height","200px"),b(e,"background","red"),b(i,"height","200px"),b(i,"background","blue"),b(n,"height","200px"),b(n,"background","green"),B(o,"data-src",oe+"/Henrik.png"),B(o,"alt","lazy image demo"),b(g,"height","200px"),b(g,"background","red"),b(m,"height","200px"),b(m,"background","blue"),b(O,"height","200px"),b(O,"background","green")},m(s,w){p(s,e,w),p(s,t,w),p(s,i,w),p(s,u,w),p(s,n,w),p(s,f,w),p(s,o,w),p(s,$,w),p(s,c,w),Y(c,V),p(s,d,w),p(s,g,w),p(s,r,w),p(s,m,w),p(s,L,w),p(s,O,w),S||(D=[G(ie.call(null,o)),G(X.call(null,c)),J(c,"enterViewport",a[0]),J(c,"exitViewport",a[1])],S=!0)},p:C,i:C,o:C,d(s){s&&l(e),s&&l(t),s&&l(i),s&&l(u),s&&l(n),s&&l(f),s&&l(o),s&&l($),s&&l(c),s&&l(d),s&&l(g),s&&l(r),s&&l(m),s&&l(L),s&&l(O),S=!1,ee(D)}}}function le(a){return[()=>console.log("entered viewport"),()=>console.log("exited viewport")]}class N extends F{constructor(e){super(),Q(this,e,le,ae,U,{})}}const fe=`<script>\r
